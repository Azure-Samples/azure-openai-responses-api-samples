...
| 🆕 Priority processing                                                           | n/a                                                                                                                                             | [responses-priority-aoai-v1.py](python/responses-priority-aoai-v1.py)                                                                             |
| 🆕 Extended Prompt Caching                                                        | n/a                                                                                              | [responses-extended-cache-aoai-v1.py](python/responses-extended-cache-aoai-v1.py)                                                                                   |
| Simple conversation (referencing the previous message ID)                       | [responses-chat-aoai.py](python/responses-chat-aoai.py)                                                                                                | [responses-chat-aoai-v1.py](python/responses-chat-aoai-v1.py)                                                                                     |
| Simple conversation (referencing the previous message ID)                       | [responses-chat-aoai.py](python/responses-chat-aoai.py)                                                                                                | [responses-chat-aoai-v1.py](python/responses-chat-aoai-v1.py)                                                                                     |
...
| Web search (API key)                                                            | n/a                                                                                                                                             | [responses-websearch-basic-v1.py](python/responses-websearch-basic-v1.py)                                                                         |
| Web search (Entra)                                                              | n/a                                                                                                                                             | [responses-websearch-entra-v1.py](python/responses-websearch-entra-v1.py)                                                                         |
| Web search (streaming)                                                          | n/a                                                                                                                                             | [responses-websearch-stream-sse-v1.py](python/responses-websearch-stream-sse-v1.py)                                                               |
| 🆕 WebIQ (API key)                                                              | n/a                                                                                                                                             | [responses-webiq-aoai-v1.py](python/responses-webiq-aoai-v1.py)                                                                                   |
| 🆕 WebIQ (Entra)                                                                | n/a                                                                                                                                             | [responses-webiq-entra-aoai-v1.py](python/responses-webiq-entra-aoai-v1.py)                                                                       |
| 🆕 WebIQ (Entra client secret from Key Vault)                                   | n/a                                                                                                                                             | [responses-webiq-entra-aoai-v1.py](python/responses-webiq-entra-aoai-v1.py)                                                                       |
| 🆕 WebIQ (Entra client secret from environment)                                 | n/a                                                                                                                                             | [responses-webiq-entra-basic-aoai-v1.py](python/responses-webiq-entra-basic-aoai-v1.py)                                                           |
...
| Image generation using gpt-image-1.5 with API key auth                         | n/a                                                                                                                                             | [responses-image-generate-aoai-v1.py](python/responses-image-generate-aoai-v1.py)                                                                 |
...
[Azure OpenAI Agent Examples](https://github.com/microsoft/agent-framework/tree/main/python/samples/02-agents/providers/azure_openai)
